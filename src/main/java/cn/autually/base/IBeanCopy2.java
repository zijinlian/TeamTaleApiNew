...
import static cn.autually.base.JXRMapping.format;
import static com.sun.org.apache.xalan.internal.xsltc.compiler.util.Type.Int;

/**
 * Created by fangzhen on 2016/12/5.
 */
public interface IBeanCopy2 {
...
//                    e.printStackTrace();
                ...
                if (dstField != null) {
                    if (srcType.getTypeName().indexOf("$") != -1) {
                        try {
...
//                            e.printStackTrace();
                        ...
                        try {
                            if (srcType.getTypeName().indexOf("$") != -1 && dstType.getTypeName().indexOf("$") != -1) {
...
//                            e.printStackTrace();
                        ...
                        try {
                            if (dstType == srcType) {
                                ...
                                dstField.set(dst, format.format(date));
