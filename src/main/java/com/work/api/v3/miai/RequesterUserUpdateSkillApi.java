 ...
 */
@AnController(path = "/v3/UserUpdateSkillApi", describe = "人才库--修改技能")
public class RequesterUserUpdateSkillApi extends BaseRequester {
    ...
    public void execute(JXRequest p) {
        ...
        try {
            ...
            talentPoolService.updateUserSkill(req,res);
        } catch (Exception e) {
    ...
    public static void main(String[] args) {
         Http h = new Http("http://localhost:8080/UserUpdateSkillApi", Http.POST);
