 ...
 */
@AnController(path = "/v3/UserAskIntermediaryApi", describe = "缘聚中行--用户求助红娘")
public class RequesterUserAskIntermediaryApi extends BaseRequester {
    ...
    public void execute(JXRequest p) {
        ...
        try {
            ...
            intermediaryService.updateUserAskIntermediary(req, res);
        } catch (Exception e) {
    ...
    public static void main(String[] args) {
        Http h = new Http("http://localhost:8080/TeamTaleApi/api/v3/UserAskIntermediaryApi", Http.POST);
