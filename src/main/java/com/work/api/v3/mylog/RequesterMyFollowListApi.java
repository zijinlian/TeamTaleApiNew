 ...
 */
@AnController(path = "/v3/myFollowList", describe = "我的日志--关注列表")
public class RequesterMyFollowListApi extends BaseRequester {
    ...
    public void execute(JXRequest p) {
        ...
        try {
            ...
            myLogService.selectMyFollowList(req,res);
        } catch (Exception e) {
    ...
    public static void main(String[] args) {
        Http h = new Http("http://localhost:8080/TeamTaleApi/api/v3/myFollowList", Http.POST);
        h.addParam("params", "{\"userId\":\"6505209\",\"page\":\"1\",\"pageSize\":\"10\"}");
