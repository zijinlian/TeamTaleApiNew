 ...
 */
@AnController(path = "/v3/ActivityUserList", describe = "缘聚中行--活动参加人员列表")
public class RequesterActivityUserListApi extends DefaultRequester {
    ...
    public void execute(JXRequest p) {
        ...
        try {
            ...
            activityService.getActivityUserList(req,res);
        } catch (Exception e) {
    ...
    public static void main(String[] args) {
         Http h = new Http("http://localhost:8080/TeamTaleApi/api/v3/ActivityUserList", Http.POST);
