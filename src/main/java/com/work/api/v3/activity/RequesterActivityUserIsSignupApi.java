 ...
 */
@AnController(path = "/v3/ActivityUserIsSignupApi", describe = "缘聚中行--用户是否报名活动")
public class RequesterActivityUserIsSignupApi extends DefaultRequester {
    ...
    public void execute(JXRequest p) {
        ...
        try {
            ...
            activityService.isSignupActivity(req,res);
        } catch (Exception e) {
    ...
    public static void main(String[] args) {
         Http h = new Http("http://localhost:8080/TeamTaleApi/api/v3/ActivityUserIsSignupApi", Http.POST);
