 ...
 */
@AnController(path = "/v3/ActivityUserCommentApi", describe = "缘聚中行--用户添加活动评论")
public class RequesterActivityUserCommentApi extends DefaultRequester {
    ...
    public void execute(JXRequest p) {
        ...
        try {
            ...
            activityService.getActivityAddUserComments(req,res);
        } catch (Exception e) {
    ...
    public static void main(String[] args) {
         Http h = new Http("http://localhost:8080/TeamTaleApi/api/v3/ActivityUserCommentApi", Http.POST);
        h.addParam("params", "{\"activityId\":\"402877815bd74805015bd74a695d0001\",\"empId\":\"7282058\",\"content\":\"今天天气很好,出去踏青\"}");
