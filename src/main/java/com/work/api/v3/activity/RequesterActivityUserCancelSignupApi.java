 ...
 */
@AnController(path = "/v3/ActivityUserCancelSignupApi", describe = "缘聚中行--用户取消报名")
public class RequesterActivityUserCancelSignupApi extends DefaultRequester {
    ...
    public void execute(JXRequest p) {
        ...
        try {
            ...
            activityService.cancelSignupActivity(req,res);
        } catch (Exception e) {
    ...
    public static void main(String[] args) {
         Http h = new Http("http://localhost:8080/TeamTaleApi/api/v3/ActivityUserCancelSignupApi", Http.POST);
